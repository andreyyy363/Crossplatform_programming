/*
Варіант 7
Базовий клас - літальний апарат. Похідні - літак і вертоліт. Створити клас
Авіакомпанія, який може містити обидва види об'єктів. Передбачити метод підрахунку
окремо літаків і вертольотів (використовувати оператор instanceof).
*/
